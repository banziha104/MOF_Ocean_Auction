...
class NameFragment constructor(val data : StoreModel) : Fragment()  {
    ...
    override fun onResume() {
        super.onResume()
        nameRecyclerview.adapter = NameRecyclerAdapter(data)
        nameRecyclerview.layoutManager = LinearLayoutManager(activity)
    }
}
